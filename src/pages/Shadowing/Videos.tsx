                        ...
                        <form onSubmit={event => { event.preventDefault(); void saveEdit(); }}>
                            ...
                            <div className="grid max-h-[65vh] grid-cols-1 gap-4 overflow-y-auto p-5 sm:grid-cols-2">
                                <label className="space-y-1.5 sm:col-span-2">
                                    ...
                                    <textarea
                                        className="min-h-12 w-full resize-y rounded-lg border border-input bg-transparent px-3 py-2 text-sm outline-none focus-visible:ring-3 focus-visible:ring-ring/50"
                                        value={draft?.title ?? ""}
